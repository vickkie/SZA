...
const Home: React.FC<PageProps> = ({ appLoaded, preloaded, navOnClick, windowWidth, setAppLoaded }) => {
  ...
  const preloadImages = () => {
    return new Promise((resolve) => {
      imagesLoaded(document.querySelectorAll("#home img"), { background: true }, resolve);
    });
  };
  ...
  return (
    <>
      ...
      <div id="home" ref={scrollRef} data-scroll-container>
        <SectionOne scroll={scroll} appLoaded={appLoaded} preloaded={preloaded} windowWidth={windowWidth} />
        <SectionTwo />
        ...
        <SectionTen windowWidth={windowWidth} />
      </div>
    </>
  );
};
